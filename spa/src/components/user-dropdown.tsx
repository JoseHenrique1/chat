...
export function UserDropdown({ friendModal, groupModal, profileModal, logoutModal }: propsUserDropdown) {
  ...
  return (
    <Menu>
      ...
      >
        ...
        <MenuItem>
          <button
            onClick={profileModal.handleOpen}
            className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 
              data-[focus]:bg-quinternary/50 text-secondary hover:text-quaternary"
          >
        ...
        <MenuItem>
          <button
            onClick={logoutModal.handleOpen}
            className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 
              data-[focus]:bg-quinternary/50 text-secondary hover:text-quaternary"
          >
